<div class="full-box page-header">
  <h3 class="text-left">
    <i class="fas fa-book"></i> &nbsp; REGISTRO PEDAGÓGICO
  </h3>
</div>

<div class="container-fluid contenedorEstatico">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
          <a href="<?php echo SERVERURL; ?>docente/pedagogico-cuaderno/"><i class="fas fa-book"></i> &nbsp; CUADERNO PEDAGÓGICO</a>
        </li>
        <li>
          <a class="active" href="<?php echo SERVERURL; ?>docente/pedagogico-registro/"><i class="fas fa-book"></i> &nbsp; REGISTRO PEDAGÓGICO</a>
        </li>
    </ul>	
</div>
      ...
      <div class="row">
          <div class="col-md-4">
              ...
              <?php
                  ...
                  $ins_curso = new controlador_registroP();
...
<div class="card cardCuaderno">
  <div class="container-fluid">
    <ul class="nav nav-pills mb-3 justify-content-center cuadernoCp" id="pills-tab" role="tablist">
      ...
      ?>
      <li class="nav-item">
        <a class="cuadernoCp nav-link" id="pills-centralizador-tab" data-toggle="pill" href="#pills-centralizador" role="tab" aria-selected="false"><i class="fas fa-book"></i>&nbsp; CUADRO CENTRALIZADOR </a>
      </li>
    </ul>
  </div>
  ...
  <div class="tab-content" id="pills-tabContent">
              ...
              <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header text-white bg-dark">
                        <div class="col-12 col-md-12">
                            <div class="input-group">
                                <div class="mr-auto"><h6>Centralizador de notas - <?php echo $rows['NOMBRE_PER'];?> </h6></div>
                                <div class="input-group-addon"></div>
                                <button type="button" class="btn btn-expand text-white" data-card-widget="collapse" title="Collapse">
                                  <i class="fas fa-expand"></i>
                                </button>
    ...
    <div class="tab-pane fade show" id="pills-centralizador" role="tabpanel">
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header text-white bg-dark">
                    <div class="col-12 col-md-12">
                        <div class="input-group">
                            <div class="mr-auto"><h6>Cuadro centralizador anual  </h6></div>
                            <div class="input-group-addon"></div>
                            <button type="button" class="btn btn-expand text-white" data-card-widget="collapse" title="Collapse">
                              <i class="fas fa-expand"></i>
                            </button>
                ...
                <div class="card-body" id="body_centralizador">
                  <div class="text-center">Seleccione un curso por favor</div>
                </div>
            </div>
        </div>
...
<?php include_once "./vista/contenido/docente/inc/registerPedagogico.php"?>
