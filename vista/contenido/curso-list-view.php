...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a class="active"  href="<?php echo SERVERURL; ?>curso-list/"><i class="fas fa-spell-check"></i> &nbsp; CURSO</a>
        </li>
        <li>
...
<div class="container-fluid">
	<p class="text-center">
		<a href="<?php echo SERVERURL; ?>curso-new/" class="btn btn-primary"><i class="fas fa-plus fa-fw"></i> &nbsp; REGISTRAR CURSO</a>
	</p>
</div>
	...
	<div class="container-fluid">
		<?php
			...
			echo $ins_curso->paginador_curso_controlador($pagina[1],15,$_SESSION['privilegio_sa'],$pagina[0],"");
		?>
	</div>
	...
	<div class="container-fluid">
		<?php
			...
			echo $ins_curso->paginador_curso_controlador($pagina[1],15,$_SESSION['privilegio_sa'],$pagina[0],$_SESSION['busqueda_curso']);
		?>
	</div>
