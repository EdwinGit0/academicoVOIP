...
<div class="container-fluid">
    ...
    <?php
		...
		$datos_periodo = $ins_periodo->datos_periodo_controlador("Unico",$pagina[1]);

		if($datos_periodo->rowCount()==1){
			$campos = $datos_periodo->fetch();
	?>

	<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/periodoAjax.php" method="POST" data-form="update" autocomplete="off">
        <input type="hidden" name="periodo_id_up" value="<?php echo $pagina[1]; ?>">
        <fieldset>
