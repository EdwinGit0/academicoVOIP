...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>periodo-list/"><i class="fas fa-layer-group"></i> &nbsp; PERIODO</a>
        </li>
        <li>
...
<div class="container-fluid">
	<p class="text-center">
		<a href="<?php echo SERVERURL; ?>periodo-new/" class="btn btn-primary"><i class="fas fa-plus fa-fw"></i> &nbsp; REGISTRAR PERIODO</a>
	</p>
</div>
	...
	<div class="container-fluid">
		<?php
			...
			echo $ins_periodo->paginador_periodo_controlador($pagina[1],15,$_SESSION['privilegio_sa'],$pagina[0],"");
		?>
	</div>
	...
	<div class="container-fluid">
		<?php
			...
			echo $ins_periodo->paginador_periodo_controlador($pagina[1],15,$_SESSION['privilegio_sa'],$pagina[0],$_SESSION['busqueda_periodo']);
		?>
	</div>
