...
<div class="container-fluid">
    <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/admin/educativoAjax.php" method="POST" data-form="save" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <label for="educativo_dependecia" class="bmd-label-floating">Dependencia</label>
							<select class="form-control" name="educativo_dependecia_reg" id="educativo_dependecia" required="">
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <label for="educativo_dpto" class="bmd-label-floating">Departamento</label>
							<select class="form-control" name="educativo_dpto_reg" id="educativo_dpto" required="">
								<option value="" selected="" disabled="">Seleccione una opción</option>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{3,150}" class="form-control" name="educativo_localidad_reg" id="educativo_localidad" maxlength="150">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="educativo_direccion" class="bmd-label-floating">Dirección</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{3,255}" class="form-control" name="educativo_direccion_reg" id="educativo_direccion" maxlength="255">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="educativo_distrito" class="bmd-label-floating">Distrito</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{3,150}" class="form-control" name="educativo_distrito_reg" id="educativo_distrito" maxlength="255">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container-fluid">
    <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/admin/educativoAjax.php" method="POST" data-form="update" autocomplete="off">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                        <label for="educativo_dependecia" class="bmd-label-floating">Dependencia</label>
							<select class="form-control" name="educativo_dependecia_up" id="educativo_dependecia" required="">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                        <label for="educativo_dpto" class="bmd-label-floating">Departamento</label>
							<select class="form-control" name="educativo_dpto_up" id="educativo_dpto" required="">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="educativo_localidad" class="bmd-label-floating">Localidad</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{3,150}" class="form-control" name="educativo_localidad_up" id="educativo_localidad" value="<?php echo $campos['LOCALIDAD_UA']; ?>" maxlength="150">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="educativo_direccion" class="bmd-label-floating">Dirección</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{3,255}" class="form-control" name="educativo_direccion_up" id="educativo_direccion" value="<?php echo $campos['DIRECCION_UA']; ?>" maxlength="255">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="educativo_distrito" class="bmd-label-floating">Distrito</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{3,150}" class="form-control" name="educativo_distrito_up" id="educativo_distrito" maxlength="255" value="<?php echo $campos['DISTRITO_UA']; ?>">
                        </div>
                    </div>
                </div>
            </div>
