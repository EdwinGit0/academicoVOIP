...
<div class="container-fluid">
	<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/admin/usuarioAjax.php" method="POST" data-form="save" autocomplete="off">
		<fieldset>
				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,30}" class="form-control" name="usuario_nombre_reg" id="usuario_nombre" maxlength="35" required="">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="usuario_apellidoP" class="bmd-label-floating">Apellido Paterno</label>
							<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,35}" class="form-control" name="usuario_apellidoP_reg" id="usuario_apellidoP" maxlength="35" required="">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="usuario_apellidoM" class="bmd-label-floating">Apellidos Materno</label>
							<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,35}" class="form-control" name="usuario_apellidoM_reg" id="usuario_apellidoM" maxlength="35" required="">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
					...
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<select class="form-control" name="usuario_tipo_reg" id="usuario_tipo" required="">
