...
<div class="container-fluid">
	...
	<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/admin/docenteAjax.php" method="POST" data-form="update" autocomplete="off">
		...
		<fieldset>
			...
			<div class="container-fluid">
				...
				<div class="input-group">
					...
					<input type="hidden" name="docente_id_educativo_up" id="docente_id_educativo" value="<?php echo main_model::encryption($campos['UA_ID']); ?>"  required="">
				...
				<div class="input-group">
					...
					<input type="hidden" name="docente_id_area_up" id="docente_id_area" value="<?php echo main_model::encryption($campos['COD_AREA']); ?>" required="">
					<div class="input-group-addon"></div>
