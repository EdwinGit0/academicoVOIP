...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>anio-list/"><i class="fas fa-tasks"></i> &nbsp; AÑO ACADÉMICO</a>
        </li>
    </ul>
</div>
...
<div class="container-fluid">
	<p class="text-center">
		<a href="<?php echo SERVERURL; ?>anio-new/" class="btn btn-primary"><i class="fas fa-plus fa-fw"></i> &nbsp; REGISTRAR AÑO ACADÉMICO</a>
	</p>
</div>
	...
	<div class="container-fluid">
		<?php
			...
			echo $ins_anio->paginador_anio_controlador($pagina[1],15,$_SESSION['privilegio_sa'],$pagina[0],"");
		?>
	</div>
	...
	<div class="container-fluid">
		<?php
			...
			echo $ins_anio->paginador_anio_controlador($pagina[1],15,$_SESSION['privilegio_sa'],$pagina[0],$_SESSION['busqueda_anio']);
		?>
	</div>
