<?php
    ...
    class controlador_usuario extends modelo_usuario{
            ...
            if($total>=1 && $pagina<=$Npaginas){
                ...
                foreach($datos as $rows){
                    $tabla.='<tr class="text-center" >
                                ...
                                <td>'.$rows['DIRECCION_AD'].'</td>
                                <td>'.$rows['CORREO_AD'].'</td>
                                <td>
                                    <a href="'.SERVERURL.'user-update/'.main_model::encryption($rows['ADMIN_ID']).'/" class="btn btn-success">
        ...
        public function actualizar_usuario_controlador(){
            ...
            /* comprobar campos vacios */
            if($nombre=="" || $apellidoP=="" || $apellidoM=="" || $email=="" || $admin_email=="" || $admin_clave==""){
                $alerta=[
                    "Alerta"=>"simple",
                    "Titulo"=>"Ocurrio un error inesperado",
                    "Texto"=>"No has llenado todos los campos obligatorios",
