<?php
    if($peticionAjax){
        require_once "../modelo/modelo_anio.php";
    }else{
        require_once "./modelo/modelo_anio.php";
    }
            ...
            if($total>=1 && $pagina<=$Npaginas){
                ...
                foreach($datos as $rows){
                    $tabla.='<tr class="text-center" >
                        ...
                        if($privilegio==1 || $privilegio ==2){
                            $tabla.='<td>
                                        <a href="'.SERVERURL.'anio-update/'.main_model::encryption($rows['COD_ANIO']).'/" class="btn btn-success">
                        ...
                        if($privilegio==1){
                            $tabla.='<td>
                                        <form class="FormularioAjax" action="'.SERVERURL.'ajax/anioAjax.php" method="POST" data-form="delete" autocomplete="off">
