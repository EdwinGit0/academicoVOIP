            ...
            if($total>=1 && $pagina<=$Npaginas){
                ...
                foreach($datos as $rows){
                    $tabla.='<tr class="text-center" >
                        ...
                        if($privilegio==1 || $privilegio ==2){
                            $tabla.='<td>
                                        <a href="'.SERVERURL.'periodo-update/'.main_model::encryption($rows['COD_PER']).'/" class="btn btn-success">
                        ...
                        if($privilegio==1){
                            $tabla.='<td>
                                        <form class="FormularioAjax" action="'.SERVERURL.'ajax/periodoAjax.php" method="POST" data-form="delete" autocomplete="off">
